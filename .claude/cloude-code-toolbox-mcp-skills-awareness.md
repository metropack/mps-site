...
_Generated: 2026-08-11T02:22:16.955Z_
...
Workspace `mcp.json` _(folder: mps-site)_

- **c:\Users\hchan\Desktop\mps-site\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\hchan\.claude.json** — _File exists — no servers defined_
